...
function PostPreview({
   ...
   return (
      ...
      >
         <h1
            className={clsx(
               'translate-y-12 text-center text-6xl font-semibold sm:p-5 sm:text-6xl md:p-6 md:text-7xl lg:text-8xl xl:text-8xl 2xl:text-8xl'
            )}
         >
            Blog
         </h1>
         ...
         {isInView ? (
            ...
            >
               {posts.map((post) => (
                  ...
                  >
                     <div className="flex h-full max-h-[180px] w-full max-w-lg items-center justify-center">
                        <Image
                           className={clsx(
         ...
         {enableShowMore ? (
            <motion.div className={clsx('max-h-12 max-w-xs')}>
               <button
                  className={clsx(
                     'mx-auto h-12 w-32 rounded-lg border-2 border-[#484848]',

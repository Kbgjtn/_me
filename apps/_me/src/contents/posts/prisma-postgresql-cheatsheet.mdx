...
image: /images/Notaroberto-Boldrini-watches-8.jpg
---
...
**[PostgreSQL](https://www.postgresql.org/docs "See PostgreSQL docs")** PostgreSQL is a relational database that is known for its reliability, performance, and scalability. It is a great choice for storing large amounts of data and handling complex queries.
...
### **Next:** [Cheat Sheet using Prisma](/ "go see now!")
